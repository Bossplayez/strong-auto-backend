...
// The copied directory had ID 554 labelled as Winnipeg. The actual calculator
// selector uses it for Wilmington (NC); Winnipeg is ID 603.
const IAAI_LOCATION_TO_PLATFORM = createLocationIndex(
  IAAI_LOCATION_DIRECTORY.replace('554:Winnipeg (MB)', '554:Wilmington (NC)'),
);
